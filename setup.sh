...
echo -e "Add admin (wait a minute before run it):  ${YELLOW}docker exec -it matrix_synapse_1 register_new_test_user -c /data/homeserver.yaml http://localhost:8008${NC}"
echo -e "-------------------------------------------------------\n"
